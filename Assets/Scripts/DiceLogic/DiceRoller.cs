...
public class DiceRoller : MonoBehaviour
{
    ...
    public void RollTo()
    {
        ...
        int faceIndex = Random.Range(1, 21); // Genera un número entre 1 y 20
    ...
    private IEnumerator RollCoroutine(int targetFace)
    {
        ...
        //Tiempo de espera antes de que el dado se dirija al centro
        ...
        EventUIManager.Instance.ShowDiceResult(targetFace);
        yield return new WaitForSeconds(0.5f);
        EventUIManager.Instance.ShowDiceResult(targetFace + EventManager.Instance.GetStatWithModifiers(EventUIManager.Instance.currentEvent.statType));
        yield return new WaitForSeconds(0.5f); // Espera un momento antes de resolver el evento
        EventUIManager.Instance.ResolveEvent(targetFace); // Resuelve el evento una vez que el dado ha llegado al centro
    }
}
